...
SELECT *
FROM term_data
WHERE (vid = 9 OR vid = 2 OR vid = 5 OR vid = 1 
...
USING(tid)
WHERE (d.vid = 9 OR d.vid = 2 OR d.vid = 5 OR d.vid = 1 
...
SELECT DISTINCT n.nid, n.tid FROM mjd6.term_node n JOIN term_data d
WHERE (d.vid = 9 OR d.vid = 2 OR d.vid = 5 OR d.vid = 1 
    OR d.tid = 22221 OR d.tid = 23631 OR d.tid = 22491) 
;
");
