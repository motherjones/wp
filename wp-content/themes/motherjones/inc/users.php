...
/**
 * Add "Former Author" custom user role.
 *
 * @return null
 */
function mj_add_roles() {
    add_role(
        'former_author',
        __('Former Author', 'mj'),
        array(
...
?>
            ...
            <p id="avatar-input" <?php print empty($image_src) ? '' : 'style="display:none;"'?>>
...
<?php
   ...
   */
     ...
     *
     * @return string    the src of the avatar
     */
