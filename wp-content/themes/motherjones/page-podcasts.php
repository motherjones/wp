...
<main id="main" class="site-main grid" role="main">
  ...
  <section id="post-<?php the_ID(); ?>" 
           class="grid__col-md-8 grid__col-sm-9 grid__col-xs-12">
    ...
    <article class="entry-content">
      ...
      <div class="podcast-item">
        <a href="/category/secondary-tags/bite"
          ...
          <img src="/wp-content/themes/motherjones/img/bite-logo-large.png" />
        </a>
        <div class="podcast-data grid__col-sm-6">
          <h2 class="title">
            <a href="/category/secondary-tags/bite">Bite</a>
          </h2>
          ...
          <p>
            ...
            tidbits along the way.
				...
				<a class="itunes-link" href="https://itunes.apple.com/us/podcast/bite/id1090260338?mt=2">
					<span>
						<img src="/wp-content/themes/motherjones/img/podcast-icon.png" />
						Subscribe on iTunes
					</span>
				</a>
			</div>
			...
			<div class="podcast-item">
				<a href="/category/secondary-tags/inquiring-minds"
           class="podcast-image grid__col-sm-6">
					<img src="/wp-content/themes/motherjones/img/inq-minds-logo-large.png" />
				</a>
        <div class="podcast-data grid__col-sm-6">
          <h2 class="title">
            <a href="/category/secondary-tags/inquiring-minds">Inquiring Minds</a>
          </h2>
