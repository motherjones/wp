<div id="static-navbar">
  ...
  <ul class="menu">
    ...
    <li class="first menu-item-home"><a href="/" title="Mother Jones Homepage">
      <img src="/wp-content/themes/motherjones/img/MJ_comp.png" srcset="<?php echo esc_attr( wp_get_attachment_image_srcset( 12 ) ); ?>" sizes="<?php echo esc_attr( $custom_header_sizes ); ?>" alt="Mother Jones">
    </a></li>
