...
class Largo_Related_Posts {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Largo_Related_Posts_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	public function __construct() {
		...
		$this->plugin_name = 'largo-related-posts';
		$this->version = '1.0.0';
	 ...
	 *
	 * - Largo_Related_Posts_Loader. Orchestrates the hooks of the plugin.
	 * - Largo_Related_Posts_i18n. Defines internationalization functionality.
	 * - Largo_Related_Posts_Admin. Defines all hooks for the admin area.
	 * - Largo_Related_Posts_Public. Defines all hooks for the public side of the site.
	 *
	 ...
	 *
	 * @since     1.0.0
	 * @return    Largo_Related_Posts_Loader    Orchestrates the hooks of the plugin.
	 */
