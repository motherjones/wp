...
/**
 * try to add custom fields hahahha jesus why cant these be consolidated
 */
class MJ_custom_fields {
  //prefix for storing custom fields in the postmeta table
  var $prefix = '_mjcf_';
  //the fields that custom fields go on
  var $post_types = array('post', 'article', 'page', 'blog_post', 'full_width');

  var $custom_fields = array(
    array(
      "name"          => "byline-override",
      "title"         => "Byline override",
      "description"   => "if you don't want the standard byline",
      "type"          => "text",
  ...
  function mjCustomFields() { $this->__construct(); }
  /**
  * PHP 5 Constructor
  */
  ...
  */
  function displayCustomFields() {
      ...
      <div class="form-wrap">
          <?php
          wp_nonce_field( 'mj-custom-fields', 'mj-custom-fields_wpnonce', false, true );
...
if ( class_exists('mjCustomFields') ) {
    $mjCustomFields_var = new mjCustomFields();
}
