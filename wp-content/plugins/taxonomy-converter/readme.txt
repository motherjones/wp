=== Taxonomy Converter ===
Contributors: kristarella, wordpressdotorg
Donate link: 
...
1. Go to the Tools -> Import screen, Click on Taxonomy Converter

== Screenshots ==
1. Import page example with custom taxonomies Genre and Writer.
