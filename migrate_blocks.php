...
a:7:{
	...
	i:2;a:6:{s:5:"title";s:9:"Site wrap";s:4:"text";s:278:"<script language="javascript"> <!-- if (typeof(MJ_HideSiteWrap) === 'undefined') { jQuery('head').append('<link rel="stylesheet" href="http://assets.motherjones.com/advertising/2014/05/sierra_club_sitewrap.css" type="text/css" />'); ad_code('siteskin',1559); } //--> </script>";
	s:6:"filter";b:0;
		s:10:"dw_include";i:0;
		s:9:"dw_logged";s:0:"";
		s:9:"other_ids";s:0:"";
	...
	i:3;a:6:{
		...
		s:4:"text";s:366:"<div id="bottom-donate" style="display:none"> <p> We noticed you have an ad blocker on.  Support nonprofit investigative reporting by pitching in a few bucks.  <a href="https://secure.motherjones.com/fnp/?action=SUBSCRIPTION&list_source=7HEGZS1A&extra_don=1&abver=A">DONATE</a> <span onclick="jQuery('#bottom-donate').remove();">X</span> </p> </div>";
		s:6:"filter";b:0;
		s:10:"dw_include";i:0;
		s:9:"dw_logged";s:0:"";
		s:9:"other_ids";s:0:"";
